...
func DefaultActions(l *locale.Strings) []ActionItem {
	return []ActionItem{
		{"mirror", l.ActionsMirrorTitle, "m", l.ActionsMirrorDesc},
		{"record", l.ActionsRecordTitle, "v", l.ActionsRecordDesc},
		{"files", l.ActionsFilesTitle, "f", l.ActionsFilesDesc},
		{"logcat", l.ActionsLogcatTitle, "l", l.ActionsLogcatDesc},
		{"packages", l.ActionsPackagesTitle, "p", l.ActionsPackagesDesc},
		{"remote", l.ActionsRemoteTitle, "o", l.ActionsRemoteDesc},
		{"screenshot", l.ActionsScreenshotTitle, "s", l.ActionsScreenshotDesc},
		{"wireless", l.ActionsWirelessTitle, "w", l.ActionsWirelessDesc},
		{"export", l.ActionsExportTitle, "e", l.ActionsExportDesc},
...
func RenderActionsModal(dev *device.Device, selectedActionIndex int, l *locale.Strings) string {
	...
	for i, act := range actions {
		...
		itemText := fmt.Sprintf("%s%-6s %-28s %s", cursor, keyBadge, act.Title, styles.HelpDescStyle.Render(act.Desc))
